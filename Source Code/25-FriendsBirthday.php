...
<div class="main-header">
	...
	<div class="container">
	 ...
	 mis one again! In addition, the dates are automatically saved to your calendar to let you know, but you also have
	 a “Create Event” button in case you wanna organize a party or event on that especific date.</p>
				</div>
			</div>
		</div>
	</div>

	<img loading="lazy" class="img-bottom" src="img/birthdays-bottom.webp" alt="friends" width="1169" height="161">
</div>
	...
	<div class="row">
		...
		<div class="col col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
			<div class="ui-block">
				...
				<div class="birthday-item inline-items">
					<div class="author-thumb">
						<img loading="lazy" src="img/avatar20-sm.webp" alt="author">
					</div>
					<div class="birthday-author-name">
						<a href="#" class="h6 author-name">Michael Maximoff</a>
		...
		<div class="col col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
			<div class="ui-block">
				...
				<div class="birthday-item inline-items">
					<div class="author-thumb">
						<img loading="lazy" src="img/avatar21-sm.webp" alt="author" width="42" height="42">
					</div>
					<div class="birthday-author-name">
						<a href="#" class="h6 author-name">Rachel Howlett</a>
		...
		<div class="col col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
			<div class="ui-block">
				...
				<div class="birthday-item inline-items">
					<div class="author-thumb">
						<img loading="lazy" src="img/avatar22-sm.webp" alt="author" width="42" height="42">
					</div>
					<div class="birthday-author-name">
		...
		<div class="col col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
			<div class="ui-block">
				...
				<div class="birthday-item inline-items">
					<div class="author-thumb">
						<img loading="lazy" src="img/avatar23-sm.webp" alt="author" width="42" height="42">
					</div>
					<div class="birthday-author-name">
		...
		<div class="col col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
			<div class="ui-block">
				...
				<div class="birthday-item inline-items">
					<div class="author-thumb">
						<img loading="lazy" src="img/avatar67-sm.webp" alt="author">
					</div>
					<div class="birthday-author-name">
						<a href="#" class="h6 author-name">Carol Summers</a>
		...
		<div class="col col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
			<div class="ui-block">
				...
				<div class="birthday-item inline-items">
					<div class="author-thumb">
						<img loading="lazy" src="img/avatar24-sm.webp" width="42" height="42" alt="author">
					</div>
					<div class="birthday-author-name">
		...
		<div class="col col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
			<div class="ui-block">
				...
				<div class="birthday-item inline-items">
					<div class="author-thumb">
						<img loading="lazy" src="img/avatar26-sm.webp" width="42" height="42" alt="author">
					</div>
					<div class="birthday-author-name">
		...
		<div class="col col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
			<div class="ui-block">
				...
				<div class="birthday-item inline-items">
					<div class="author-thumb">
						<img loading="lazy" src="img/avatar27-sm.webp" width="42" height="42" alt="author">
					</div>
					<div class="birthday-author-name">
		...
		<div class="col col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
			<div class="ui-block">
				...
				<div class="birthday-item inline-items">
					<div class="author-thumb">
						<img loading="lazy" src="img/avatar28-sm.webp" width="42" height="42" alt="author">
					</div>
					<div class="birthday-author-name">
		...
		<div class="col col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
			<div class="ui-block">
				...
				<div class="birthday-item inline-items">
					<div class="author-thumb">
						<img loading="lazy" src="img/avatar29-sm.webp" width="42" height="42" alt="author">
					</div>
					<div class="birthday-author-name">
		...
		<div class="col col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
			<div class="ui-block">
				...
				<div class="birthday-item inline-items">
					<div class="author-thumb">
						<img loading="lazy" src="img/avatar32-sm.webp" alt="author">
					</div>
					<div class="birthday-author-name">
		...
		<div class="col col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
			<div class="ui-block">
				...
				<div class="birthday-item inline-items">
					<div class="author-thumb">
						<img loading="lazy" src="img/avatar35-sm.webp" alt="author">
					</div>
					<div class="birthday-author-name">
