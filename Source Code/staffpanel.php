...
<div class="tab-content">
	...
	?>" id="about" role="tabpanel" aria-labelledby="about-tab"><?php include("viewstaff.php"); ?></div>
	<div class="tab-pane fade <?php
	if($_GET['view'] == "staff")
	{
	echo " show active ";
	}
	?>" id="statistics" role="tabpanel" aria-labelledby="statistics-tab"><?php include("staff.php"); ?></div>
