									...
									<li class="nav-item" role="presentation">
										...
										?>" id="statistics-tab" data-bs-toggle="tab" href="#statistics" role="tab" aria-controls="statistics" aria-selected="false">
											<svg class="olymp-stats-icon">
												<use xlink:href="#olymp-accordion-open-icon"></use>
											</svg>
...
<div class="tab-content">
	...
	<div class="tab-pane fade <?php
										if(isset($_GET['view']))
										{
											if($_GET['view'] == "ViewStudyMaterial")
											{
											echo " show active ";
											}
										}
										...
										?>" id="about" role="tabpanel" aria-labelledby="about-tab"><?php include("viewstudymaterial.php"); ?></div>
	...
	<div class="tab-pane fade <?php
								...
								?>" id="statistics" role="tabpanel" aria-labelledby="statistics-tab"><?php include("studymaterial.php"); ?></div>
