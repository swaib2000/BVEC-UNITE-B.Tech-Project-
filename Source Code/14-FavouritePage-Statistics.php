						...
						<div class="row">
							<div class="col col-xl-8 m-auto col-lg-8 col-md-12">
								<ul class="profile-menu">
									<li>
										<a href="12-FavouritePage.php" class="active">Timeline</a>
									</li>
									<li>
										<a href="13-FavouritePage-About.php">About</a>
									</li>
									<li>
									...
									<li>
										<a href="14-FavouritePage-Statistics.php">Statistics</a>
									</li>
									<li>
										<a href="15-FavouritePage-Events.php">Events</a>
									</li>
								</ul>
							</div>
						</div>
				...
				<div class="ui-block-content">
					<div class="monthly-indicator">
						<a href="#" class="btn btn-control bg-breez">
							<svg class="olymp-stats-arrow"><use xlink:href="#olymp-stats-arrow"></use></svg>
						</a>
