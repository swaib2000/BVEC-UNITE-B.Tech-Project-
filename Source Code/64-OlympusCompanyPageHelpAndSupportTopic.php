...
<head>
	...
	<title>Company Page - Help & Support Topic</title>
...
<div class="stunning-header bg-primary-opacity">
	...
	<div class="stunning-header-content">
		<h1 class="stunning-header-title">Help &amp; Support</h1>
		<ul class="breadcrumbs">
			...
			<li class="breadcrumbs-item active">
				<span>How do I post media on my account?</span>
			</li>
		</ul>
	</div>
			...
			<div class="col col-xl-10 m-auto col-lg-10 col-md-12 col-sm-12 col-12">
				...
				<form class="form-inline search-form" method="post">
					<div class="form-group label-floating">
						<label class="control-label">What do you need help with?</label>
						<input class="form-control bg-white" placeholder="" type="text" value="How do I change my profile picture?">
					</div>
...
<section>
	<div class="container">
		<div class="row">
			<div class="col col-xl-8 ms-auto order-xl-2 col-lg-8 order-lg-2 col-md-12 order-md-1 col-sm-12 col-12">

				
				<!-- Help Main Topic -->
				
				<div class="help-main-topic">
					<h3 class="title">How do I post media on my account?</h3>
					<div class="single-post-additional inline-items">
						<div class="post__author author vcard inline-items">
							<img loading="lazy" alt="author" src="img/avatar5.webp" width="92" height="92" class="avatar">
						...
						<div class="post-date-wrap inline-items">
							...
							<div class="post-date">
								<a class="h6 date" href="#">August 24th, 201</a>
					...
					<img class="help-image" src="img/help1.webp" alt="screen" width="771" height="441">
					...
					<div class="user-raiting-choice">
						...
						<a href="#">
							<img loading="lazy" src="img/icon-chat29.webp" alt="icon" width="20" height="20">
						</a>
				...
				<div class="help-support-block">
					...
					<ul class="help-support-list">
						<li>
							...
							<a href="#">Creating your Olympus account</a>
						</li>
						<li>
							<svg class="olymp-blog-icon"><use xlink:href="#olymp-blog-icon"></use></svg>
							<a href="#">How do I post media on my account?</a>
						</li>
						<li>
							<svg class="olymp-blog-icon"><use xlink:href="#olymp-blog-icon"></use></svg>
							<a href="#">Inviting friends to join Olympus</a>
						</li>
						<li>
							<svg class="olymp-blog-icon"><use xlink:href="#olymp-blog-icon"></use></svg>
							<a href="#">How do I search for my friends?</a>
						</li>
						<li>
							<svg class="olymp-blog-icon"><use xlink:href="#olymp-blog-icon"></use></svg>
							<a href="#">Create and manage friend groups</a>
						</li>
						<li>
							<svg class="olymp-blog-icon"><use xlink:href="#olymp-blog-icon"></use></svg>
							<a href="#">How does the Olympus account synchronization works?</a>
						</li>
						<li>
							<svg class="olymp-blog-icon"><use xlink:href="#olymp-blog-icon"></use></svg>
							<a href="#">Creating a live video feed</a>
						</li>
						<li>
							<svg class="olymp-blog-icon"><use xlink:href="#olymp-blog-icon"></use></svg>
						...
						<li>
							<svg class="olymp-blog-icon"><use xlink:href="#olymp-blog-icon"></use></svg>
							<a href="#">Can I have a personal account and a fav account at the same time?</a>
						</li>
						<li>
							<svg class="olymp-blog-icon"><use xlink:href="#olymp-blog-icon"></use></svg>
							<a href="#">Winning profile badges</a>
						</li>
						<li>
							<svg class="olymp-blog-icon"><use xlink:href="#olymp-blog-icon"></use></svg>
							<a href="#">Creating a live video feed</a>
						...
						<li>
							<svg class="olymp-blog-icon"><use xlink:href="#olymp-blog-icon"></use></svg>
							<a href="#">Profile badges tiers</a>
						</li>
						<li>
							<svg class="olymp-blog-icon"><use xlink:href="#olymp-blog-icon"></use></svg>
							<a href="#">Adding friends birthdays</a>
						</li>
						<li>
							<svg class="olymp-blog-icon"><use xlink:href="#olymp-blog-icon"></use></svg>
