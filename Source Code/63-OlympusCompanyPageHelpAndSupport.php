			...
			<div class="col col-xl-8 m-auto col-lg-8 col-md-12 col-sm-12 col-12">
				...
				<div class="search-help-result">
					<h3 class="search-help-result-title">
						<span class="count-result">3 results</span>
						found for:
						<span class="search-query"> “How do I change my profile picture?”</span>
					</h3>
				
					<ul class="search-help-result-list">
						<li>
							<h2 class="title">Changing you profile picture</h2>
							...
							<div class="user-raiting">
								...
								<span>84% of users found this helpful</span>
							</div>
						</li>
						<li>
							<h2 class="title">Profile picture guidelines</h2>
							<div class="single-post-additional inline-items">
								<div class="post__author author vcard inline-items">
								...
								<div class="post-date-wrap inline-items">
									<svg class="olymp-calendar-icon"><use xlink:href="#olymp-calendar-icon"></use></svg>
									<div class="post-date">
										<a class="h6 date" href="#">March 17th, 2016</a>
										<span>Last Updated</span>
									</div>
								</div>
							</div>
							...
							<div class="user-raiting">
								...
								<span>20% of users found this helpful</span>
							</div>
						</li>
						<li>
							<h2 class="title">Report a profile picture</h2>
							<div class="single-post-additional inline-items">
								<div class="post__author author vcard inline-items">
									<img loading="lazy" alt="author" src="img/avatar5.webp" width="92" height="92" class="avatar">
									<div class="author-date not-uppercase">
								...
								<div class="post-date-wrap inline-items">
									<svg class="olymp-calendar-icon"><use xlink:href="#olymp-calendar-icon"></use></svg>
									<div class="post-date">
										<a class="h6 date" href="#">September 6th, 2014</a>
										<span>Last Updated</span>
									</div>
								</div>
							</div>
