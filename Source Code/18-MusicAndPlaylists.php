...
<div class="main-header">
		...
		<div class="row">
			<div class="col col-lg-8 m-auto col-md-8 col-sm-12 col-12">
				<div class="main-header-content">
					...
					<p>Here you’ll be able to manage your Spotify playlist widget and listen all the saved playlists from your
	 friends! Friends playlists will update when they update their Olympus playlists, that way you can build awesome playlists
	...
	<img loading="lazy" class="img-bottom" src="img/music-bottom.webp" alt="friends" width="1169" height="169">
</div>
				...
				<div class="ui-block-content">
					...
					<div class="row">
						<div class="col col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
							<a href="#" class="btn btn-secondary btn-lg full-width" data-bs-toggle="modal" data-bs-target="#faqs-popup">Link your Playlist FAQs</a>
						</div>
						<div class="col col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
							<a href="#" class="btn btn-green btn-lg full-width btn-icon-left">
								<svg width="22" height="22"><use xlink:href="#olymp-spotify-icon"></use></svg>
		...
		<div class="col col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
			<div class="ui-block">
				<div class="ui-block-title">
					<h6 class="title">Green Goo’s Playlist</h6>
					<a href="#" class="more">
							<span data-bs-toggle="tooltip" data-bs-placement="top"   data-bs-original-title="SAVE PLAYLIST">
								<svg class="olymp-save-playlist-icon"><use xlink:href="#olymp-save-playlist-icon"></use></svg>
							</span>
					</a>
				</div>
				...
				<ol class="widget w-playlist without-cover">
					<li class="js-open-popup" data-popup-target=".playlist-popup">
						<div class="playlist-thumb" data-bs-toggle="tooltip" data-bs-placement="top" title="PLAY / ADD TO PLAYER">
							<a href="#" class="play-icon">
		...
		<div class="col col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
			<div class="ui-block">
				...
				<ol class="widget w-playlist">
					<li class="js-open-popup" data-popup-target=".playlist-popup">
						<div class="playlist-thumb" data-bs-toggle="tooltip" data-bs-placement="top" title="PLAY / ADD TO PLAYER">
							<img loading="lazy" src="img/playlist11.webp" alt="thumb-composition" width="34" height="34">
							<div class="overlay"></div>
							<a href="#" class="play-icon">
								<svg class="olymp-music-play-icon-big"><use xlink:href="#olymp-music-play-icon-big"></use></svg>
							</a>
					...
					<li class="js-open-popup" data-popup-target=".playlist-popup">
						<div class="playlist-thumb" data-bs-toggle="tooltip" data-bs-placement="top" title="PLAY / ADD TO PLAYER">
							<img loading="lazy" src="img/playlist12.webp" alt="thumb-composition" width="34" height="34">
							<div class="overlay"></div>
							<a href="#" class="play-icon">
								<svg class="olymp-music-play-icon-big"><use xlink:href="#olymp-music-play-icon-big"></use></svg>
							</a>
					...
					<li class="js-open-popup" data-popup-target=".playlist-popup">
						<div class="playlist-thumb" data-bs-toggle="tooltip" data-bs-placement="top" title="PLAY / ADD TO PLAYER">
							<img loading="lazy" src="img/playlist13.webp" alt="thumb-composition" width="34" height="34">
							<div class="overlay"></div>
							<a href="#" class="play-icon">
								<svg class="olymp-music-play-icon-big"><use xlink:href="#olymp-music-play-icon-big"></use></svg>
							</a>
					...
					<li class="js-open-popup" data-popup-target=".playlist-popup">
						<div class="playlist-thumb" data-bs-toggle="tooltip" data-bs-placement="top" title="PLAY / ADD TO PLAYER">
							<img loading="lazy" src="img/playlist14.webp" alt="thumb-composition" width="34" height="34">
							<div class="overlay"></div>
							<a href="#" class="play-icon">
								<svg class="olymp-music-play-icon-big"><use xlink:href="#olymp-music-play-icon-big"></use></svg>
							</a>
					...
					<li class="js-open-popup" data-popup-target=".playlist-popup">
						<div class="playlist-thumb" data-bs-toggle="tooltip" data-bs-placement="top" title="PLAY / ADD TO PLAYER">
							<img loading="lazy" src="img/playlist15.webp" alt="thumb-composition" width="34" height="34">
							<div class="overlay"></div>
							<a href="#" class="play-icon">
								<svg class="olymp-music-play-icon-big"><use xlink:href="#olymp-music-play-icon-big"></use></svg>
							</a>
		...
		<div class="col col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
			<div class="ui-block">
				...
				<ol class="widget w-playlist">
					<li class="js-open-popup" data-popup-target=".playlist-popup">
						<div class="playlist-thumb" data-bs-toggle="tooltip" data-bs-placement="top" title="PLAY / ADD TO PLAYER">
							<img loading="lazy" src="img/playlist16.webp" alt="thumb-composition" width="34" height="34">
							<div class="overlay"></div>
							<a href="#" class="play-icon">
								<svg class="olymp-music-play-icon-big"><use xlink:href="#olymp-music-play-icon-big"></use></svg>
							</a>
					...
					<li class="js-open-popup" data-popup-target=".playlist-popup">
						<div class="playlist-thumb" data-bs-toggle="tooltip" data-bs-placement="top" title="PLAY / ADD TO PLAYER">
							<img loading="lazy" src="img/playlist17.webp" alt="thumb-composition" width="34" height="34">
							<div class="overlay"></div>
							<a href="#" class="play-icon">
								<svg class="olymp-music-play-icon-big"><use xlink:href="#olymp-music-play-icon-big"></use></svg>
							</a>
					...
					<li class="js-open-popup" data-popup-target=".playlist-popup">
						<div class="playlist-thumb" data-bs-toggle="tooltip" data-bs-placement="top" title="PLAY / ADD TO PLAYER">
							<img loading="lazy" src="img/playlist18.webp" alt="thumb-composition" width="34" height="34">
							<div class="overlay"></div>
							<a href="#" class="play-icon">
								<svg class="olymp-music-play-icon-big"><use xlink:href="#olymp-music-play-icon-big"></use></svg>
							</a>
					...
					<li class="js-open-popup" data-popup-target=".playlist-popup">
						<div class="playlist-thumb" data-bs-toggle="tooltip" data-bs-placement="top" title="PLAY / ADD TO PLAYER">
							<img loading="lazy" src="img/playlist20.webp" alt="thumb-composition" width="34" height="34">
							<div class="overlay"></div>
							<a href="#" class="play-icon">
								<svg class="olymp-music-play-icon-big"><use xlink:href="#olymp-music-play-icon-big"></use></svg>
							</a>
