		...
		<div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
			...
			<div class="ui-block features-video">
				<div class="video-player">
					<img loading="lazy" src="img/video9.webp" alt="photo" width="912" height="570">
			...
			<div class="ui-block">
				<div class="ui-block-title">
					...
					<div class="align-right">
						<a href="#" class="btn btn-primary btn-md-2" data-bs-toggle="modal" data-bs-target="#update-header-photo">Upload Video  +</a>
					</div>
				</div>
			</div>
		</div>
...
<div class="container">
	<div class="row">
		...
		<div class="col col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
			...
			<div class="ui-block video-item">
				<div class="video-player">
					<img loading="lazy" src="img/video14.webp" alt="photo" width="318" height="212">
					<a href="https://youtube.com/watch?v=excVFQ2TWig" class="play-video play-video--small">
						<svg class="olymp-play-icon"><use xlink:href="#olymp-play-icon"></use></svg>
					</a>
					<div class="overlay overlay-dark"></div>
		...
		<div class="col col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
			...
			<div class="ui-block video-item">
				<div class="video-player">
					<img loading="lazy" src="img/video15.webp" alt="photo" width="318" height="212">
					<a href="https://youtube.com/watch?v=excVFQ2TWig" class="play-video play-video--small">
						<svg class="olymp-play-icon"><use xlink:href="#olymp-play-icon"></use></svg>
					</a>
					<div class="overlay overlay-dark"></div>
		...
		<div class="col col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
			...
			<div class="ui-block video-item">
				<div class="video-player">
					<img loading="lazy" src="img/video16.webp" alt="photo" width="318" height="212">
					<a href="https://youtube.com/watch?v=excVFQ2TWig" class="play-video play-video--small">
						<svg class="olymp-play-icon"><use xlink:href="#olymp-play-icon"></use></svg>
					</a>
					<div class="overlay overlay-dark"></div>
		...
		<div class="col col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
			...
			<div class="ui-block video-item">
				<div class="video-player">
					<img loading="lazy" src="img/video17.webp" alt="photo" width="318" height="212">
					<a href="https://youtube.com/watch?v=excVFQ2TWig" class="play-video play-video--small">
						<svg class="olymp-play-icon"><use xlink:href="#olymp-play-icon"></use></svg>
					</a>
					<div class="overlay overlay-dark"></div>
