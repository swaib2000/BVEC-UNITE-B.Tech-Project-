							...
							<div class="col col-xl-8 m-auto col-lg-8 col-md-12">
								<ul class="nav nav-tabs social-menu-tabs" id="social-menu-tabs" role="tablist">
									...
									<li class="nav-item" role="presentation">
										...
										?>" id="index-tab" data-bs-toggle="tab" href="#index" role="tab" aria-controls="index" aria-selected="true">
...
<div class="tab-content">
	<div class="tab-pane fade <?php
										...
										?>" id="index" role="tabpanel" aria-labelledby="index-tab"><?php include("quizresultstaff.php"); ?></div>
...
?>" id="about" role="tabpanel" aria-labelledby="about-tab"><?php include("viewquiz.php"); ?></div>
...
?>" id="statistics" role="tabpanel" aria-labelledby="statistics-tab"><?php include("quiz.php"); ?></div>
