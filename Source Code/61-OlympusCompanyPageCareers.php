...
<head>
	...
	<title>Company Page - Careers</title>
			...
			<div class="col col-xl-10 col-lg-10 col-md-12 col-sm-12 col-12 m-auto">
				...
				<ul class="table-careers">
					...
					<li>
						...
						<span><a href="#" class="btn btn-primary btn-sm full-width" data-bs-toggle="modal" data-bs-target="#edit-my-poll-popup">Apply Now!</a></span>
					</li>
		...
		<div class="info-box-wrap">
			<div class="row">
				<div class="col col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
					...
					<div class="crumina-module crumina-info-box crumina-info-box--thumb-left">
						<div class="info-box-image">
							<img loading="lazy" src="img/info7.webp" alt="icon" width="40" height="51">
						</div>
				...
				<div class="col col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
					...
					<div class="crumina-module crumina-info-box crumina-info-box--thumb-left">
						<div class="info-box-image">
							<img loading="lazy" src="img/info8.webp" alt="icon" width="32" height="56">
						</div>
						<div class="info-box-content">
				...
				<div class="col col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
					...
					<div class="crumina-module crumina-info-box crumina-info-box--thumb-left">
						<div class="info-box-image">
							<img loading="lazy" src="img/info9.webp" alt="icon" width="49" height="61">
						</div>
						<div class="info-box-content">
				...
				<div class="col col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
					...
					<div class="crumina-module crumina-info-box crumina-info-box--thumb-left">
						<div class="info-box-image">
							<img loading="lazy" src="img/info10.webp" alt="icon" width="42" height="42">
						</div>
						<div class="info-box-content">
				...
				<div class="col col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
					...
					<div class="crumina-module crumina-info-box crumina-info-box--thumb-left">
						<div class="info-box-image">
							<img loading="lazy" src="img/info11.webp" alt="icon" width="36" height="46">
						</div>
						<div class="info-box-content">
				...
				<div class="col col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
					...
					<div class="crumina-module crumina-info-box crumina-info-box--thumb-left">
						<div class="info-box-image">
							<img loading="lazy" src="img/info12.webp" alt="icon" width="42" height="52">
						</div>
						<div class="info-box-content">
		...
		<div class="row">
			<div class="col col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 m-auto">
				...
				<div class="follow-instagram">
					<img loading="lazy" src="img/inst5.webp" alt="photo" width="154" height="270">
					<img loading="lazy" src="img/inst4.webp" alt="photo" width="169" height="297">
					<img loading="lazy" src="img/inst3.webp" alt="photo" width="155" height="270">
					<img loading="lazy" src="img/inst2.webp" alt="photo" width="154" height="270">
					<img loading="lazy" src="img/inst1.webp" alt="photo" width="154" height="270">
					<div class="overlay overlay-dark"></div>
					<a href="#" class="btn btn-blue btn-lg with--icon">
						<img loading="lazy" class="icon" src="img/inst-logo.webp" alt="app store" width="33" height="33">
						<div class="text">
