		...
		<div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
			<div class="ui-block">
				<div class="ui-block-title">
					<div class="h6 title">Available Widgets</div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
			<div class="ui-block responsive-flex">
				<div class="ui-block-title">
					<div class="h6 title">Profile Customization</div>

					<div class="align-right">
						<a href="#" class="btn btn-md-2 btn-border-think custom-color c-grey">Back to Preset Settings</a>
						<a href="#" class="btn btn-primary btn-md-2">Save all Changes</a>
					</div>
				</div>
			</div>
		</div>
...
<div class="container">
	<div class="row">
		<div class="col col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12">
			<div class="ui-block">
				<div class="available-widget">
					<div class="h6 title">Profile Intro</div>
					<div class="more">
						<svg class="olymp-three-dots-icon"><use xlink:href="#olymp-three-dots-icon"></use></svg>
						<ul class="more-dropdown">
							<li>
								<a href="#" data-bs-toggle="modal" data-bs-target="#edit-widget-profile">Edit Widget</a>
							</li>

							<li>
								<a href="#">Preview Widget</a>
							</li>
						</ul>
					</div>
				</div>
			...
			<div class="ui-block">
				<div class="available-widget">
					<div class="h6 title">My Badges</div>
					<div class="more">
						<svg class="olymp-three-dots-icon"><use xlink:href="#olymp-three-dots-icon"></use></svg>
						<ul class="more-dropdown">
							<li>
								<a href="#" data-bs-toggle="modal" data-bs-target="#edit-widget-twitter">Edit Widget</a>
							</li>
							<li>
								<a href="#">Preview Widget</a>
							</li>
			...
			<div class="ui-block">
				<div class="available-widget">
					<div class="h6 title">Spotify Playlist</div>
					<div class="more">
						<svg class="olymp-three-dots-icon"><use xlink:href="#olymp-three-dots-icon"></use></svg>
						<ul class="more-dropdown">
							<li>
			...
			<div class="ui-block">
				<div class="available-widget">
					<div class="h6 title">Twitter Feed</div>
					<div class="more">
						<svg class="olymp-three-dots-icon"><use xlink:href="#olymp-three-dots-icon"></use></svg>
						<ul class="more-dropdown">
							<li>
		...
		<div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
			<article class="hentry post empty-post">
				...
				<div class="empty-post-content">
					<div class="title">Your Post Updates Space</div>
		...
		<div class="col col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12">
			<div class="ui-block">
				<div class="available-widget">
					<div class="h6 title">Last Photos</div>
					<div class="more">
						<svg class="olymp-three-dots-icon"><use xlink:href="#olymp-three-dots-icon"></use></svg>
						<ul class="more-dropdown">
							<li>
			...
			<div class="ui-block">
				<div class="available-widget">
					<div class="h6 title">Blog Posts</div>
					<div class="more">
						<svg class="olymp-three-dots-icon"><use xlink:href="#olymp-three-dots-icon"></use></svg>
						<ul class="more-dropdown">
							<li>
								<a href="#" data-bs-toggle="modal" data-bs-target="#edit-widget-blog-post">Edit Widget</a>
							</li>
							<li>
								<a href="#">Preview Widget</a>
							</li>
			...
			<div class="ui-block">
				<div class="available-widget">
					<div class="h6 title">My Friends</div>
					<div class="more">
						<svg class="olymp-three-dots-icon"><use xlink:href="#olymp-three-dots-icon"></use></svg>
						<ul class="more-dropdown">
							<li>
			...
			<div class="ui-block">
				<div class="available-widget">
					<div class="h6 title">Favourite Pages</div>
					<div class="more">
						<svg class="olymp-three-dots-icon"><use xlink:href="#olymp-three-dots-icon"></use></svg>
						<ul class="more-dropdown">
							<li>
			...
			<div class="ui-block">
				<div class="available-widget">
					<div class="h6 title">My Poll</div>
					<div class="more">
						<svg class="olymp-three-dots-icon"><use xlink:href="#olymp-three-dots-icon"></use></svg>
						<ul class="more-dropdown">
							<li>
								<a href="#" data-bs-toggle="modal" data-bs-target="#edit-widget-pool">Edit Widget</a>
							</li>
							<li>
								<a href="#">Preview Widget</a>
							</li>
