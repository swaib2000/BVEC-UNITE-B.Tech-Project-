			...
			<div class="ui-block">
				...
				<table class="forums-table">
					...
					<tr>
						<td class="forum">
							<div class="forum-item">
								<img loading="lazy" src="img/forum7.webp" alt="forum" width="36" height="45">
								<div class="content">
					...
					<tr>
						<td class="forum">
							<div class="forum-item">
								<img loading="lazy" src="img/forum8.webp" alt="forum" width="37" height="51">
								<div class="content">
						...
						<td class="freshness">
							<div class="author-freshness">
								<div class="author-thumb">
									<img loading="lazy" src="img/avatar76-sm.webp" alt="author" width="28" height="28">
								</div>
					...
					<tr class="bg-smoke-light">
						<td class="forum">
							<div class="forum-item">
								<svg class="icon" width="15" height="15"><use xlink:href="#olymp-star-full"></use></svg>
								<div class="content">
						...
						<td class="freshness">
							<div class="author-freshness">
								<div class="author-thumb">
									<img loading="lazy" src="img/avatar72-sm.webp" alt="author">
								</div>
					...
					<tr>
						<td class="forum">
							<div class="forum-item">
								...
								<div class="author-started">
									<span>Started by:</span>
									<div class="author-thumb">
										<img loading="lazy" src="img/avatar70-sm.webp" alt="author">
									</div>
						...
						<td class="freshness">
							<div class="author-freshness">
								<div class="author-thumb">
									<img loading="lazy" src="img/avatar79-sm.webp" alt="author" width="28" height="28">
								</div>
						...
						<td class="forum">
							<div class="forum-item">
								...
								<div class="author-started">
									<span>Started by:</span>
									<div class="author-thumb">
										<img loading="lazy" src="img/avatar80-sm.webp" alt="author" width="28" height="28">
									</div>
						...
						<td class="forum">
							<div class="forum-item">
								...
								<div class="author-started">
									<span>Started by:</span>
									<div class="author-thumb">
										<img loading="lazy" src="img/avatar81-sm.webp" alt="author" width="20" height="20">
									</div>
					...
					<tr>
						...
						<td class="freshness">
							<div class="author-freshness">
								<div class="author-thumb">
									<img loading="lazy" src="img/avatar82-sm.webp" alt="author" width="28" height="28">
								</div>
					...
					<tr>
						<td class="forum">
							<div class="forum-item">
								...
								<div class="author-started">
									<span>Started by:</span>
									<div class="author-thumb">
										<img loading="lazy" src="img/faved-page5.webp" alt="author">
									</div>
						...
						<td class="freshness">
							<div class="author-freshness">
								<div class="author-thumb">
									<img loading="lazy" src="img/faved-page10.webp" alt="author">
								</div>
