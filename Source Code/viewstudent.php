...
if(isset($_GET['delid']))
{
	...
	echo "<script>window.location='monitor.php?view=Student';</script>";
}
...
<input type="submit" class="btn btn-danger" name="btndelete" value="Delete Record"  style="width: 120px;">
<table border="1" border="1" id="datatable" class="table table-striped table-bordered" cellspacing="0" style="width:100%;">
    <thead>        
  <tr>
    <th scope="col"><input type="checkbox" name="select_all" id="select_all" onClick="checkall()" style='width: 25px;' ></th>
 ...
 while($rsrec = mysqli_fetch_array($qsql))
  {
    ...
    echo "<tr>
    <td>&nbsp;<input type='checkbox' style='width: 25px;' class='checkbox' name='check[]' value='$rsrec[0]'></td>
	...
	if($_SESSION['user_type'] == "Admin")
	{
	echo "<td>&nbsp;<a href='viewstudent.php?delid=$rsrec[student_id]' onclick='return deleteconfirm()' class='btn btn-danger'>Delete</a></td>";
	}
	echo " </tr>";
  }
  ?>
