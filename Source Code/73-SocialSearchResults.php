...
<header class="header header-responsive" id="site-header-responsive">
	...
	<div class="header-content-wrapper">
		<ul class="nav nav-tabs mobile-notification-tabs" role="tablist">
			<li class="nav-item">
				<a class="nav-link" data-bs-toggle="tab" href="#request" role="tab">
...
<div class="container">
	<div class="row">
		...
		<div class="col col-xl-6 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
					...
					<article class="hentry post searches-item">
						...
						<div class="post__author author vcard inline-items">
							...
							<div class="author-date">
								<a class="h6 post__author-name fn" href="02-ProfilePage.php">Marina Valentine</a>
				...
				<div class="ui-block">
					...
					<article class="hentry post searches-item">
						...
						<div class="post__author author vcard inline-items">
							...
							<div class="author-date">
								<a class="h6 post__author-name fn" href="02-ProfilePage.php">Dave Marinara</a>
				...
				<div class="ui-block">
					...
					<article class="hentry post searches-item">
						...
						<div class="post__author author vcard inline-items">
							...
							<div class="author-date">
								<a class="h6 post__author-name fn" href="02-ProfilePage.php">The Marina Bar</a>
			...
			<a id="load-more-button" href="#" class="btn btn-control btn-more" data-load-link="search-items-to-load.php" data-container="search-items-grid">
			...
			<div class="ui-block">
				...
				<div class="widget w-action">
					...
					<div class="content">
						...
						<a href="01-LandingPage.php" class="btn btn-bg-secondary btn-md">Register Now!</a>
					</div>
				</div>
