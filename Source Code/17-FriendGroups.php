		...
		<div class="col col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
			...
			<div class="friend-item friend-groups create-group h-75 mb-3">
				...
				<div class="content">
					...
					<a href="#" class="  btn btn-control bg-blue" data-bs-toggle="modal" data-bs-target="#create-friend-group-1">
			...
			<div class="ui-block h-100 mb-0">
				...
				<div class="friend-item friend-groups">
					...
					<div class="friend-item-content">
						...
						<div class="friend-avatar">
							<div class="author-thumb">
								<img loading="lazy" src="img/friend-group1.webp" alt="photo" width="120" height="120">
							</div>
							<div class="author-content">
			...
			<div class="ui-block h-100 mb-0">
				...
				<div class="friend-item friend-groups">
					...
					<div class="friend-item-content">
						...
						<div class="friend-avatar">
							<div class="author-thumb">
								<img loading="lazy" src="img/friend-group2.webp" alt="photo" width="120" height="120">
							</div>
							<div class="author-content">
			...
			<div class="ui-block h-100 mb-0">
				...
				<div class="friend-item friend-groups">
					...
					<div class="friend-item-content">
						...
						<div class="friend-avatar">
							<div class="author-thumb">
								<img loading="lazy" src="img/friend-group3.webp" alt="photo" width="120" height="120">
							</div>
							<div class="author-content">
			...
			<div class="ui-block h-100 mb-0">
				...
				<div class="friend-item friend-groups">
					...
					<div class="friend-item-content">
						...
						<div class="friend-avatar">
							<div class="author-thumb">
								<img loading="lazy" src="img/friend-group4.webp" alt="photo" width="120" height="120">
							</div>
							<div class="author-content">
