...
<head>
	...
	<title>Company Page Blog list</title>
...
<div class="stunning-header bg-primary-opacity">
	...
	<div class="stunning-header-content">
		<h1 class="stunning-header-title">Blog List</h1>
			...
			<div class="col col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
				...
				<div class="ui-block">
					...
					<article class="hentry blog-post blog-post-v3">
						...
						<div class="post-content">
							...
							<a href="#" class="h3 post-title">Take a look at these truly awesome worspaces</a>
							<p>Here’s a photo from last month’s photoshoot. We had a lot of fun doing it and got really
								awesome shots for the new summer catalog.
							</p>
				...
				<div class="ui-block">
					...
					<article class="hentry blog-post blog-post-v3">
						...
						<div class="post-thumb">
							<img loading="lazy" src="img/post4.webp" alt="photo" width="368" height="259">
							<a href="#" class="post-category bg-primary">OLYMPUS NEWS</a>
						</div>
						...
						<div class="post-content">
							...
							<a href="#" class="h3 post-title">Here’s the Featured Urban photo of July!</a>
							<p>Here’s a photo from last month’s photoshoot. We had a lot of fun doing it and got really
								awesome shots for the new summer catalog.
							</p>
				...
				<div class="ui-block">
					...
					<article class="hentry blog-post blog-post-v3">
						...
						<div class="post-content">
							...
							<a href="#" class="h3 post-title">Olympus’s family picnic was a success!</a>
							<p>Here’s a photo from last month’s photoshoot. We had a lot of fun doing it and got really
								awesome shots for the new summer catalog.
							</p>
				...
				<div class="ui-block">
					...
					<article class="hentry blog-post blog-post-v3">
						...
						<div class="post-content">
							...
							<a href="#" class="h3 post-title">Olympians: Journal of my backpacking days</a>
							<p>Here’s a photo from last month’s photoshoot. We had a lot of fun doing it and got really
								awesome shots for the new summer catalog.
							</p>
