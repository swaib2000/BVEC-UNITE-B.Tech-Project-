...
<div class="tab-content">
	...
	<div class="tab-pane fade <?php
										...
										?>" id="about" role="tabpanel" aria-labelledby="about-tab"><?php include("viewstudent.php"); ?></div>
	...
	<div class="tab-pane fade <?php
								...
								?>" id="statistics" role="tabpanel" aria-labelledby="statistics-tab"><?php include("viewtimeline.php"); ?></div>
