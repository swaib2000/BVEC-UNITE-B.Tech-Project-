...
<head>
	...
	<title>Profile Page - Fav Pages</title>
					...
					<div class="w-select">
						...
						<fieldset class="form-group">
							<select class="form-select">
								<option value="NU">Number of Favourites</option>
								<option value="NU">Number of Photos</option>
								<option value="NU">Number of Videos</option>
							</select>
						</fieldset>
					</div>
	...
	<div class="row">
		...
		<div class="col col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
			<div class="ui-block">
				...
				<div class="friend-item fav-page">
					<div class="friend-header-thumb">
						<img loading="lazy" src="img/fav4.webp" alt="friend" width="318" height="122">
					</div>
					...
					<div class="friend-item-content">
						...
						<div class="friend-avatar">
							<div class="author-thumb">
								<img loading="lazy" src="img/avatar12.webp" alt="author" width="92" height="92">
							</div>
							<div class="author-content">
								<a href="#" class="h5 author-name">Mannequin Angel</a>
								<div class="country">Clothing Store</div>
							</div>
						</div>
		...
		<div class="col col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
			<div class="ui-block">
				...
				<div class="friend-item fav-page">
					<div class="friend-header-thumb">
						<img loading="lazy" src="img/fav5.webp" alt="friend" width="318" height="122">
					</div>
					...
					<div class="friend-item-content">
						...
						<div class="friend-avatar">
							<div class="author-thumb">
								<img loading="lazy" src="img/avatar13.webp" alt="author" width="92" height="92">
							</div>
							<div class="author-content">
								<a href="#" class="h5 author-name">Blue Whale Pizzas</a>
								<div class="country">Restaurant / Bar</div>
							</div>
						</div>
		...
		<div class="col col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
			<div class="ui-block">
				...
				<div class="friend-item fav-page">
					<div class="friend-header-thumb">
						<img loading="lazy" src="img/fav6.webp" alt="friend" width="318" height="122">
					</div>
					...
					<div class="friend-item-content">
						...
						<div class="friend-avatar">
							<div class="author-thumb">
								<img loading="lazy" src="img/avatar14.webp" alt="author" width="92" height="92">
							</div>
							<div class="author-content">
								<a href="#" class="h5 author-name">Crimson Agency</a>
		...
		<div class="col col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
			<div class="ui-block">
				...
				<div class="friend-item fav-page">
					<div class="friend-header-thumb">
						<img loading="lazy" src="img/fav7.webp" alt="friend" width="318" height="122">
					</div>
					...
					<div class="friend-item-content">
						...
						<div class="friend-avatar">
							<div class="author-thumb">
								<img loading="lazy" src="img/avatar15.webp" alt="author" width="92" height="92">
							</div>
							<div class="author-content">
								<a href="#" class="h5 author-name">Thompson’s Custom...</a>
								<div class="country">Clothing Store</div>
							</div>
						</div>
