...
<head>
	...
	<title>Functionality Contact Form</title>
		...
		<div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
			<div class="ui-block">
				<div class="ui-block-title">
					<h6 class="title">Functionality Contact Form</h6>
				</div>
					...
					<form class="crumina-submit" method="post" data-nonce="crumina-submit-form-nonce" data-type="standard" action="modules/forms/submit.php">
						...
						<div class="row">
							...
							<div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
								...
								<button class="btn btn-md btn-primary">Submit form</button>
							</div>
						</div>
					</form>
				</div>
...
<!-- jQuery-scripts for Contact Form -->
