...
<div class="container">
	<div class="row">
		<div class="col col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
			...
			<div class="ui-block responsive-flex">
				<div class="ui-block-title">
					<svg class="icon c-yellow" width="14" height="14"><use xlink:href="#olymp-star-full"></use></svg>
				...
				<table class="open-topic-table">
					...
					<tr>
						<td class="author">
							...
							<div class="author-content">
								<a href="02-ProfilePage.php" class="h6 author-name">Marina Valentine</a>
					...
					<tr>
						<td class="author">
							...
							<div class="author-content">
								<a href="02-ProfilePage.php" class="h6 author-name">Mathilda Brinker</a>
					...
					<tr>
						<td class="author">
							...
							<div class="author-content">
								<a href="02-ProfilePage.php" class="h6 author-name">Nicholas Grissom</a>
					...
					<tr>
						<td class="author">
							...
							<div class="author-content">
								<a href="02-ProfilePage.php" class="h6 author-name">Carol Summers</a>
								<div class="country">Los Angeles, CA</div>
							</div>
						</td>
						<td class="posts">
					...
					<tr>
						<td class="author">
							...
							<div class="author-content">
								<a href="02-ProfilePage.php" class="h6 author-name">Chris Greyson</a>
