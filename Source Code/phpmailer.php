...
{
	$loginid 	= "campussocialnetwork@myprojectcoding.xyz";
	$password 	= "CV#@Pzcqz#b-";
	$smtpserver = "mail.myprojectcoding.xyz";
	$smtpport 	= 26;
	$mailsender = "<?php echo $_SESSION['project_title']; ?>";
	$companyname= "<?php echo $_SESSION['project_title']; ?>";
	$facebook = "https://www.facebook.com/CampusSocialNetwork";
	$twitter = "https://www.twitter.com/CampusSocialNetwork";
	$youtube = "https://www.youtube.com/CampusSocialNetwork";
	$linkedin = "https://www.linkedin.com/CampusSocialNetwork";
	$companyaddress  = "<?php echo $_SESSION['project_title']; ?>, 9-57, Wadi-e-Hadees, Hyderabad-500005, India | Email us: CampusSocialNetwork@gmail.com";
	$contactno = "+91-9550313048";
	$url = "www.CampusSocialNetwork.in";
